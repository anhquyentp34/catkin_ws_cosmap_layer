...
void modelStatesCallback(const gazebo_msgs::ModelStatesConstPtr &msg)
{
    ...
    for(size_t i =0; i<msg->name.size(); i++)
    {
        if((msg->name[i] == "actor0")||(msg->name[i] == "actor1")||(msg->name[i] == "actor2")||(msg->name[i] == "actor3")||(msg->name[i] == "actor4")||(msg->name[i] == "actor5")
          ||(msg->name[i] == "actor_30")||(msg->name[i] == "actor31")||(msg->name[i] == "actor32")||(msg->name[i] == "actor33")||(msg->name[i] == "actor34")||(msg->name[i] == "actor35")
          ||(msg->name[i] == "actor36")||(msg->name[i] == "actor37")||(msg->name[i] == "actor38")||(msg->name[i] == "actor_39")||(msg->name[i] == "actor40"))
        {
             k = k+ 1;
            //
            tf::quaternionMsgToTF(msg->pose[i].orientation, quat);
            ...
            // moving people
            if((msg->name[i] == "actor1")||(msg->name[i] == "actor_30")||(msg->name[i] == "actor2")){
            ...
            // sitting people
            if((msg->name[i] == "actor_30")||(msg->name[i] == "actor31")||(msg->name[i] == "actor32")||(msg->name[i] == "actor33")||(msg->name[i] == "actor34")||(msg->name[i] == "actor35")
...
int main(int argc, char ** argv)
{
    ...
    human_pose_pub = nh.advertise<people_msgs::People>("/people",5);
